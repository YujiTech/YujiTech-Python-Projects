...
class BankSystem(object):
    ...
    def transferMoney(self):
            ...
            l_title=tk.Message(tfwn,text="YujiTech Banking System",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
    ...
    def update_customer_name(self,sender):
        ...
        l_title=tk.Message(ndwn,text="YujiTech Banking System",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
        l_title.config(font=("Courier","50","bold"))
        l_title.pack(side="top")
    ...
    def update_customer_address(self,sender):
        ...
        l_title=tk.Message(nawn,text="YujiTech Banking System",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
        l_title.config(font=("Courier","50","bold"))
        l_title.pack(side="top")
    ...
    def run_account_options(self,sender,admin):
        ...
        l_title=tk.Message(cawn,text="YujiTech Banking System",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
        l_title.config(font=("Courier","50","bold"))
        l_title.pack(side="top")
    ...
    def delete_customer(self,admin_obj):
        ...
        if admin_obj.has_full_admin_right():
            ...
            l_title=tk.Message(dcwn,text="YujiTech Banking System",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
            l_title.config(font=("Courier","50","bold"))
            l_title.pack(side="top")
...
#         messagebox.showinfo("Login Succesfull")
    ...
    def run_admin_options(self,admin_obj):
        ...
        l_title=tk.Message(opwn,text="YujiTech Banking System",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
        l_title.config(font=("Courier","50","bold"))
        l_title.pack(side="top")
    ...
    def login(self,master):
        ...
        l_title=tk.Message(crwn,text="YujiTech Banking System",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
        l_title.config(font=("Courier","50","bold"))
        l_title.pack(side="top")
